  ...
  return (
    <>
      ...
      >
        ...
        <div 
          ref={contactRef}
          className="flex flex-col flex-wrap justifybetween gap-8 md:flex-row">
            <div className='font-light'>
              <p className='tracking-wider text-white/50'>E-mail</p>
              <p className='text-xl tracking-widest lowercase text-pretty'>chittaranjan.tech@gmail.com</p>
            </div>
            <div className='font-light'>
