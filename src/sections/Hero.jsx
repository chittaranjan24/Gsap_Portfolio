...
const Hero = () => {
    ...
    const aboutText = `I help growing brands and startups gain an
     unfait advantage through premium
        ...
        <div ref={contextRef}>
            ...
            >
                <div ref={headerRef} className="flex flex-col justify-center gap-0.2 pt-16 sm:gap-16">
                    ...
                    <div className="px-10">
                        <h1 className="flex flex-col flex-wrap gap-12 text-black uppercase banner-text-responsive sm:gap-16 md:block">Chittaranjan</h1>
                    </div>
                </div>
            </div>
